...
trait MediaTrackConstraintSet extends StObject {
  ...
  /* standard dom */
  var backgroundBlur: js.UndefOr[ConstrainBoolean] = js.undefined
...
object MediaTrackConstraintSet {
  ...
  implicit open class MutableBuilder[Self <: MediaTrackConstraintSet] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundBlur(value: ConstrainBoolean): Self = StObject.set(x, "backgroundBlur", value.asInstanceOf[js.Any])
