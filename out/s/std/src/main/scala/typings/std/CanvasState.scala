...
trait CanvasState extends StObject {
  ...
  /* standard dom */
  def isContextLost(): scala.Boolean
...
object CanvasState {
  ...
  inline def apply(isContextLost: () => scala.Boolean, reset: () => Unit, restore: () => Unit, save: () => Unit): CanvasState = {
  ...
  implicit open class MutableBuilder[Self <: CanvasState] (val x: Self) extends AnyVal {
    ...
    inline def setIsContextLost(value: () => scala.Boolean): Self = StObject.set(x, "isContextLost", js.Any.fromFunction0(value))
