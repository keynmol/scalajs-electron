...
trait RTCSessionDescription extends StObject {
  ...
  /* standard dom */
  def toJSON(): org.scalajs.dom.RTCSessionDescriptionInit
...
object RTCSessionDescription {
  ...
  inline def apply(
    ...
    toJSON: () => org.scalajs.dom.RTCSessionDescriptionInit,
    `type`: org.scalajs.dom.RTCSdpType
  ...
  implicit open class MutableBuilder[Self <: RTCSessionDescription] (val x: Self) extends AnyVal {
    ...
    inline def setToJSON(value: () => org.scalajs.dom.RTCSessionDescriptionInit): Self = StObject.set(x, "toJSON", js.Any.fromFunction0(value))
