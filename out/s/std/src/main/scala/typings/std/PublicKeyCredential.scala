...
trait PublicKeyCredential
  ...
  /* standard dom */
  def toJSON(): PublicKeyCredentialJSON
}
object PublicKeyCredential {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getClientExtensionResults = js.Any.fromFunction0(getClientExtensionResults), id = id.asInstanceOf[js.Any], rawId = rawId.asInstanceOf[js.Any], response = response.asInstanceOf[js.Any], toJSON = js.Any.fromFunction0(toJSON), authenticatorAttachment = null)
  ...
  implicit open class MutableBuilder[Self <: PublicKeyCredential] (val x: Self) extends AnyVal {
    ...
    inline def setToJSON(value: () => PublicKeyCredentialJSON): Self = StObject.set(x, "toJSON", js.Any.fromFunction0(value))
  }
}
