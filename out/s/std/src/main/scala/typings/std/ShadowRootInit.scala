...
trait ShadowRootInit extends StObject {
  ...
  /* standard dom */
  var serializable: js.UndefOr[scala.Boolean] = js.undefined
...
object ShadowRootInit {
  ...
  implicit open class MutableBuilder[Self <: ShadowRootInit] (val x: Self) extends AnyVal {
    ...
    inline def setSerializable(value: scala.Boolean): Self = StObject.set(x, "serializable", value.asInstanceOf[js.Any])
