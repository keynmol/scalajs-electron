...
trait CSSRule extends StObject {
  ...
  /* standard dom */
  val COUNTER_STYLE_RULE: `11`
  
  /* standard dom */
  val FONT_FACE_RULE: `5`
  
  /* standard dom */
  val FONT_FEATURE_VALUES_RULE: `14`
...
object CSSRule {
  ...
  inline def apply(cssText: java.lang.String, `type`: Double): CSSRule = {
    val __obj = js.Dynamic.literal(CHARSET_RULE = 2, COUNTER_STYLE_RULE = 11, FONT_FACE_RULE = 5, FONT_FEATURE_VALUES_RULE = 14, IMPORT_RULE = 3, KEYFRAMES_RULE = 7, KEYFRAME_RULE = 8, MEDIA_RULE = 4, NAMESPACE_RULE = 10, PAGE_RULE = 6, STYLE_RULE = 1, SUPPORTS_RULE = 12, cssText = cssText.asInstanceOf[js.Any], parentRule = null, parentStyleSheet = null)
  ...
  implicit open class MutableBuilder[Self <: CSSRule] (val x: Self) extends AnyVal {
    ...
    inline def setCOUNTER_STYLE_RULE(value: `11`): Self = StObject.set(x, "COUNTER_STYLE_RULE", value.asInstanceOf[js.Any])
    ...
    inline def setFONT_FEATURE_VALUES_RULE(value: `14`): Self = StObject.set(x, "FONT_FEATURE_VALUES_RULE", value.asInstanceOf[js.Any])
