...
/* n */ NumberDictionary[T] {
  ...
  def entries(): ArrayIterator[js.Tuple2[Double, T]] = js.native
  ...
  def toLocaleString(locales: java.lang.String, options: NumberFormatOptions & DateTimeFormatOptions): java.lang.String = js.native
  def toLocaleString(locales: js.Array[java.lang.String]): java.lang.String = js.native
  def toLocaleString(locales: js.Array[java.lang.String], options: NumberFormatOptions & DateTimeFormatOptions): java.lang.String = js.native
  ...
  /**
    ...
    */
  /* standard es2015.iterable */
  def values(): ArrayIterator[T] = js.native
}
