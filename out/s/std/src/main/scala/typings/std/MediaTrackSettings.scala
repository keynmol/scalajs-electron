...
trait MediaTrackSettings extends StObject {
  ...
  /* standard dom */
  var backgroundBlur: js.UndefOr[scala.Boolean] = js.undefined
...
object MediaTrackSettings {
  ...
  implicit open class MutableBuilder[Self <: MediaTrackSettings] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundBlur(value: scala.Boolean): Self = StObject.set(x, "backgroundBlur", value.asInstanceOf[js.Any])
