...
object GamepadEffectParameters {
  ...
  implicit open class MutableBuilder[Self <: GamepadEffectParameters] (val x: Self) extends AnyVal {
    ...
    inline def setLeftTriggerUndefined: Self = StObject.set(x, "leftTrigger", js.undefined)
    
    inline def setRightTrigger(value: Double): Self = StObject.set(x, "rightTrigger", value.asInstanceOf[js.Any])
    
    inline def setRightTriggerUndefined: Self = StObject.set(x, "rightTrigger", js.undefined)
