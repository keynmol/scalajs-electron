...
trait WindowEventHandlersEventMap extends StObject {
  ...
  /* standard dom */
  var pagereveal: org.scalajs.dom.Event
  
  /* standard dom */
  var pageshow: PageTransitionEvent
  
  /* standard dom */
  var pageswap: org.scalajs.dom.Event
...
object WindowEventHandlersEventMap {
  ...
  implicit open class MutableBuilder[Self <: WindowEventHandlersEventMap] (val x: Self) extends AnyVal {
    ...
    inline def setPagereveal(value: org.scalajs.dom.Event): Self = StObject.set(x, "pagereveal", value.asInstanceOf[js.Any])
    
    inline def setPageshow(value: PageTransitionEvent): Self = StObject.set(x, "pageshow", value.asInstanceOf[js.Any])
    
    inline def setPageswap(value: org.scalajs.dom.Event): Self = StObject.set(x, "pageswap", value.asInstanceOf[js.Any])
