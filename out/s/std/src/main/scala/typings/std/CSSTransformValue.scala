...
/* index */ NumberDictionary[CSSTransformComponent] {
  ...
  def entries(): ArrayIterator[js.Tuple2[Double, CSSTransformComponent]] = js.native
  ...
  var iterator: js.Function0[ArrayIterator[CSSTransformComponent]] = js.native
  ...
  /* standard dom.iterable */
  def values(): ArrayIterator[CSSTransformComponent] = js.native
}
