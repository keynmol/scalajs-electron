...
trait HTMLElement
  ...
  /* standard dom */
  var popover: java.lang.String | Null = js.native
  ...
  /* standard dom */
  def togglePopover(): scala.Boolean = js.native
  def togglePopover(options: scala.Boolean): scala.Boolean = js.native
  ...
  /* standard dom */
  var writingSuggestions: java.lang.String = js.native
}
