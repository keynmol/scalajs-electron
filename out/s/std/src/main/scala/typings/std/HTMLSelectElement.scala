...
import typings.std.stdStrings.`select-multiple`
import typings.std.stdStrings.`select-one`
...
/* name */ NumberDictionary[org.scalajs.dom.HTMLOptionElement | org.scalajs.dom.HTMLOptGroupElement] {
  ...
  var iterator: js.Function0[ArrayIterator[org.scalajs.dom.HTMLOptionElement]] = js.native
  ...
  /**
    ...
    */
  /* standard dom */
  val `type`: `select-one` | `select-multiple` = js.native
