...
@JSGlobal("CSSViewTransitionRule")
@js.native
/* standard dom */
open class CSSViewTransitionRule ()
  extends StObject
     with typings.std.CSSViewTransitionRule {
  ...
  /* standard dom */
  /* CompleteClass */
  override val navigation: java.lang.String = js.native
