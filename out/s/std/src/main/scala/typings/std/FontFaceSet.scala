...
trait FontFaceSet
  ...
  def addEventListener_loading(
    `type`: loading,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ FontFaceSetLoadEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_loading(
    `type`: loading,
  ...
  /* standard dom */
  var onloading: (js.ThisFunction1[/* this */ this.type, /* ev */ FontFaceSetLoadEvent, Any]) | Null = js.native
  
  /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/FontFaceSet/loadingdone_event) */
  /* standard dom */
  var onloadingdone: (js.ThisFunction1[/* this */ this.type, /* ev */ FontFaceSetLoadEvent, Any]) | Null = js.native
  
  /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/FontFaceSet/loadingerror_event) */
  /* standard dom */
  var onloadingerror: (js.ThisFunction1[/* this */ this.type, /* ev */ FontFaceSetLoadEvent, Any]) | Null = js.native
