...
import typings.std.CanvasFontStretch
import typings.std.CanvasFontVariantCaps
...
import typings.std.CanvasTextRendering
...
open class CanvasRenderingContext2D ()
  ...
  /* standard dom */
  /* CompleteClass */
  override def getContextAttributes(): CanvasRenderingContext2DSettings = js.native
  ...
  /* standard dom */
  /* CompleteClass */
  override def isContextLost(): scala.Boolean = js.native
