...
import typings.std.Intl.NumberFormatOptionsCurrencyDisplay
import typings.std.Intl.NumberFormatOptionsStyle
...
object stdStrings {
  ...
  @js.native
  sealed trait ContentVisibilityAutoStateChangeEvent extends StObject
  inline def ContentVisibilityAutoStateChangeEvent: ContentVisibilityAutoStateChangeEvent = "ContentVisibilityAutoStateChangeEvent".asInstanceOf[ContentVisibilityAutoStateChangeEvent]
  ...
  @js.native
  sealed trait PageRevealEvent extends StObject
  inline def PageRevealEvent: PageRevealEvent = "PageRevealEvent".asInstanceOf[PageRevealEvent]
  
  @js.native
  sealed trait PageSwapEvent extends StObject
  inline def PageSwapEvent: PageSwapEvent = "PageSwapEvent".asInstanceOf[PageSwapEvent]
  ...
  @js.native
  sealed trait ToggleEvent extends StObject
  inline def ToggleEvent: ToggleEvent = "ToggleEvent".asInstanceOf[ToggleEvent]
  ...
  @js.native
  sealed trait `dual-rumble`
    extends StObject
       with GamepadHapticEffectType
  ...
  sealed trait f32
    extends StObject
       with AudioSampleFormat
       with ValueType
  inline def f32: f32 = "f32".asInstanceOf[f32]
  
  @js.native
  sealed trait `f32-planar`
    extends StObject
       with AudioSampleFormat
  inline def `f32-planar`: `f32-planar` = "f32-planar".asInstanceOf[`f32-planar`]
  ...
  @js.native
  sealed trait `media-playout`
    extends StObject
       with RTCStatsType
  inline def `media-playout`: `media-playout` = "media-playout".asInstanceOf[`media-playout`]
  ...
  @js.native
  sealed trait pagereveal extends StObject
  inline def pagereveal: pagereveal = "pagereveal".asInstanceOf[pagereveal]
  ...
  @js.native
  sealed trait pageswap extends StObject
  inline def pageswap: pageswap = "pageswap".asInstanceOf[pageswap]
  ...
  @js.native
  sealed trait `s16-planar`
    extends StObject
       with AudioSampleFormat
  inline def `s16-planar`: `s16-planar` = "s16-planar".asInstanceOf[`s16-planar`]
  ...
  @js.native
  sealed trait `s32-planar`
    extends StObject
       with AudioSampleFormat
  inline def `s32-planar`: `s32-planar` = "s32-planar".asInstanceOf[`s32-planar`]
  ...
  @js.native
  sealed trait `tel-local-prefix`
    extends StObject
       with AutoFillContactField
  inline def `tel-local-prefix`: `tel-local-prefix` = "tel-local-prefix".asInstanceOf[`tel-local-prefix`]
  
  @js.native
  sealed trait `tel-local-suffix`
    extends StObject
       with AutoFillContactField
  inline def `tel-local-suffix`: `tel-local-suffix` = "tel-local-suffix".asInstanceOf[`tel-local-suffix`]
  ...
  @js.native
  sealed trait `trigger-rumble`
    extends StObject
       with GamepadHapticEffectType
  inline def `trigger-rumble`: `trigger-rumble` = "trigger-rumble".asInstanceOf[`trigger-rumble`]
  ...
  @js.native
  sealed trait `u8-planar`
    extends StObject
       with AudioSampleFormat
  inline def `u8-planar`: `u8-planar` = "u8-planar".asInstanceOf[`u8-planar`]
