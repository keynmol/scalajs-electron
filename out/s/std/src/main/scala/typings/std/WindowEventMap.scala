...
object WindowEventMap {
  ...
  inline def apply(
    ...
    pagereveal: org.scalajs.dom.Event,
    pageshow: PageTransitionEvent,
    pageswap: org.scalajs.dom.Event,
