...
trait MediaTrackCapabilities extends StObject {
  ...
  /* standard dom */
  var backgroundBlur: js.UndefOr[js.Array[scala.Boolean]] = js.undefined
...
object MediaTrackCapabilities {
  ...
  implicit open class MutableBuilder[Self <: MediaTrackCapabilities] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundBlur(value: js.Array[scala.Boolean]): Self = StObject.set(x, "backgroundBlur", value.asInstanceOf[js.Any])
    
    inline def setBackgroundBlurUndefined: Self = StObject.set(x, "backgroundBlur", js.undefined)
    
    inline def setBackgroundBlurVarargs(value: scala.Boolean*): Self = StObject.set(x, "backgroundBlur", js.Array(value*))
