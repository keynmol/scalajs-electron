...
trait GlobalEventHandlersEventMap extends StObject {
  ...
  /* standard dom */
  var beforetoggle: org.scalajs.dom.Event
  ...
  /* standard dom */
  var scrollend: org.scalajs.dom.Event
...
object GlobalEventHandlersEventMap {
  ...
  implicit open class MutableBuilder[Self <: GlobalEventHandlersEventMap] (val x: Self) extends AnyVal {
    ...
    inline def setBeforetoggle(value: org.scalajs.dom.Event): Self = StObject.set(x, "beforetoggle", value.asInstanceOf[js.Any])
    ...
    inline def setScrollend(value: org.scalajs.dom.Event): Self = StObject.set(x, "scrollend", value.asInstanceOf[js.Any])
