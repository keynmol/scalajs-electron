...
trait HTMLVideoElementEventMap
  ...
  /* standard dom */
  var enterpictureinpicture: PictureInPictureEvent
  
  /* standard dom */
  var leavepictureinpicture: PictureInPictureEvent
}
object HTMLVideoElementEventMap {
  ...
  implicit open class MutableBuilder[Self <: HTMLVideoElementEventMap] (val x: Self) extends AnyVal {
    ...
    inline def setEnterpictureinpicture(value: PictureInPictureEvent): Self = StObject.set(x, "enterpictureinpicture", value.asInstanceOf[js.Any])
    
    inline def setLeavepictureinpicture(value: PictureInPictureEvent): Self = StObject.set(x, "leavepictureinpicture", value.asInstanceOf[js.Any])
  }
}
