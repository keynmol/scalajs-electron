...
trait PointerLockOptions extends StObject {
  ...
  /* standard dom */
  var unadjustedMovement: js.UndefOr[scala.Boolean] = js.undefined
}
object PointerLockOptions {
  ...
  implicit open class MutableBuilder[Self <: PointerLockOptions] (val x: Self) extends AnyVal {
    ...
    inline def setUnadjustedMovement(value: scala.Boolean): Self = StObject.set(x, "unadjustedMovement", value.asInstanceOf[js.Any])
