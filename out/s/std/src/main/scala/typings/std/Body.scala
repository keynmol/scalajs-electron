...
trait Body extends StObject {
  ...
  /* standard dom */
  def bytes(): js.Promise[js.typedarray.Uint8Array]
...
object Body {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(arrayBuffer = js.Any.fromFunction0(arrayBuffer), blob = js.Any.fromFunction0(blob), bodyUsed = bodyUsed.asInstanceOf[js.Any], bytes = js.Any.fromFunction0(bytes), formData = js.Any.fromFunction0(formData), json = js.Any.fromFunction0(json), text = js.Any.fromFunction0(text), body = null)
  ...
  implicit open class MutableBuilder[Self <: Body] (val x: Self) extends AnyVal {
    ...
    inline def setBytes(value: () => js.Promise[js.typedarray.Uint8Array]): Self = StObject.set(x, "bytes", js.Any.fromFunction0(value))
