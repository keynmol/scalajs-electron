...
trait StylePropertyMapReadOnly extends StObject {
  ...
  def entries(): StylePropertyMapReadOnlyIterator[js.Tuple2[java.lang.String, js.Iterable[CSSStyleValue]]] = js.native
  ...
  var iterator: js.Function0[
    StylePropertyMapReadOnlyIterator[js.Tuple2[java.lang.String, js.Iterable[CSSStyleValue]]]
  ] = js.native
  
  /* standard dom.iterable */
  def keys(): StylePropertyMapReadOnlyIterator[java.lang.String] = js.native
