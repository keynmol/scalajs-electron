...
trait GetHTMLOptions extends StObject {
  ...
  /* standard dom */
  var serializableShadowRoots: js.UndefOr[scala.Boolean] = js.undefined
...
object GetHTMLOptions {
  ...
  implicit open class MutableBuilder[Self <: GetHTMLOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSerializableShadowRoots(value: scala.Boolean): Self = StObject.set(x, "serializableShadowRoots", value.asInstanceOf[js.Any])
