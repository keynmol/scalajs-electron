...
object ClassFieldDecoratorContext {
  ...
  inline def apply[This, Value](
    ...
    val __obj = js.Dynamic.literal(access = access.asInstanceOf[js.Any], addInitializer = js.Any.fromFunction1(addInitializer), kind = "field", metadata = metadata.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], static = static.asInstanceOf[js.Any])
