...
object CSSFontPaletteValuesRule {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(CHARSET_RULE = 2, COUNTER_STYLE_RULE = 11, FONT_FACE_RULE = 5, FONT_FEATURE_VALUES_RULE = 14, IMPORT_RULE = 3, KEYFRAMES_RULE = 7, KEYFRAME_RULE = 8, MEDIA_RULE = 4, NAMESPACE_RULE = 10, PAGE_RULE = 6, STYLE_RULE = 1, SUPPORTS_RULE = 12, basePalette = basePalette.asInstanceOf[js.Any], cssText = cssText.asInstanceOf[js.Any], fontFamily = fontFamily.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], overrideColors = overrideColors.asInstanceOf[js.Any], parentRule = null, parentStyleSheet = null)
