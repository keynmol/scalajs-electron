...
import typings.std.anon.Name
import typings.std.stdStrings.Ed25519
import typings.std.stdStrings.jwk
import typings.std.stdStrings.sign
import typings.std.stdStrings.verify
...
trait SubtleCrypto extends StObject {
  ...
  def deriveBits(algorithm: org.scalajs.dom.EcdhKeyDeriveParams, baseKey: org.scalajs.dom.CryptoKey): js.Promise[js.typedarray.ArrayBuffer] = js.native
  ...
  def deriveBits(algorithm: org.scalajs.dom.Pbkdf2Params, baseKey: org.scalajs.dom.CryptoKey): js.Promise[js.typedarray.ArrayBuffer] = js.native
  ...
  /* standard dom */
  def deriveBits(algorithm: AlgorithmIdentifier, baseKey: org.scalajs.dom.CryptoKey): js.Promise[js.typedarray.ArrayBuffer] = js.native
  ...
  def deriveBits(algorithm: HkdfParams, baseKey: org.scalajs.dom.CryptoKey): js.Promise[js.typedarray.ArrayBuffer] = js.native
  ...
  /* standard dom */
  def exportKey(format: org.scalajs.dom.KeyFormat, key: org.scalajs.dom.CryptoKey): js.Promise[js.typedarray.ArrayBuffer | org.scalajs.dom.JsonWebKey] = js.native
  /* standard dom */
  @JSName("exportKey")
  ...
  /* standard dom */
  def generateKey(algorithm: Name, extractable: scala.Boolean, keyUsages: js.Array[sign | verify]): js.Promise[org.scalajs.dom.CryptoKeyPair] = js.native
  def generateKey(algorithm: Ed25519, extractable: scala.Boolean, keyUsages: js.Array[sign | verify]): js.Promise[org.scalajs.dom.CryptoKeyPair] = js.native
