...
trait HTMLVideoElement
  ...
  def addEventListener_enterpictureinpicture(
    ...
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ PictureInPictureEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_enterpictureinpicture(
    `type`: enterpictureinpicture,
  ...
  /* standard dom */
  var onenterpictureinpicture: (js.ThisFunction1[/* this */ this.type, /* ev */ PictureInPictureEvent, Any]) | Null = js.native
  
  /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/HTMLVideoElement/leavepictureinpicture_event) */
  /* standard dom */
  var onleavepictureinpicture: (js.ThisFunction1[/* this */ this.type, /* ev */ PictureInPictureEvent, Any]) | Null = js.native
