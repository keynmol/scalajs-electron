...
trait MIDIPort
  ...
  def addEventListener_statechange(
    `type`: statechange,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ MIDIConnectionEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_statechange(
    `type`: statechange,
  ...
  /* standard dom */
  var onstatechange: (js.ThisFunction1[/* this */ this.type, /* ev */ MIDIConnectionEvent, Any]) | Null = js.native
