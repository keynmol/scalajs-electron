...
object ClassMethodDecoratorContext {
  ...
  inline def apply[This, Value /* <: js.ThisFunction1[/* this */ This, /* args */ Any, Any] */](
    ...
    val __obj = js.Dynamic.literal(access = access.asInstanceOf[js.Any], addInitializer = js.Any.fromFunction1(addInitializer), kind = "method", metadata = metadata.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], static = static.asInstanceOf[js.Any])
