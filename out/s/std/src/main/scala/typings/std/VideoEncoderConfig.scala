...
trait VideoEncoderConfig extends StObject {
  ...
  /* standard dom */
  var contentHint: js.UndefOr[java.lang.String] = js.undefined
...
object VideoEncoderConfig {
  ...
  implicit open class MutableBuilder[Self <: VideoEncoderConfig] (val x: Self) extends AnyVal {
    ...
    inline def setContentHint(value: java.lang.String): Self = StObject.set(x, "contentHint", value.asInstanceOf[js.Any])
    
    inline def setContentHintUndefined: Self = StObject.set(x, "contentHint", js.undefined)
