...
trait RTCOutboundRtpStreamStats
  ...
  /* standard dom */
  var qualityLimitationDurations: js.UndefOr[Record[java.lang.String, Double]] = js.undefined
  
  /* standard dom */
  var qualityLimitationReason: js.UndefOr[RTCQualityLimitationReason] = js.undefined
...
object RTCOutboundRtpStreamStats {
  ...
  implicit open class MutableBuilder[Self <: RTCOutboundRtpStreamStats] (val x: Self) extends AnyVal {
    ...
    inline def setQualityLimitationDurations(value: Record[java.lang.String, Double]): Self = StObject.set(x, "qualityLimitationDurations", value.asInstanceOf[js.Any])
    
    inline def setQualityLimitationDurationsUndefined: Self = StObject.set(x, "qualityLimitationDurations", js.undefined)
    
    inline def setQualityLimitationReason(value: RTCQualityLimitationReason): Self = StObject.set(x, "qualityLimitationReason", value.asInstanceOf[js.Any])
    
    inline def setQualityLimitationReasonUndefined: Self = StObject.set(x, "qualityLimitationReason", js.undefined)
