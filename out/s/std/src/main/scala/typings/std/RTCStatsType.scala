...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.std.stdStrings.`media-playout`
...
object RTCStatsType {
  ...
  inline def `media-playout`: typings.std.stdStrings.`media-playout` = "media-playout".asInstanceOf[typings.std.stdStrings.`media-playout`]
