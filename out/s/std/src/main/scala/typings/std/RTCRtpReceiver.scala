...
trait RTCRtpReceiver extends StObject {
  ...
  /* standard dom */
  var jitterBufferTarget: DOMHighResTimeStamp | Null
  ...
  /* standard dom */
  var transform: RTCRtpTransform | Null
...
object RTCRtpReceiver {
  ...
  implicit open class MutableBuilder[Self <: RTCRtpReceiver] (val x: Self) extends AnyVal {
    ...
    inline def setJitterBufferTarget(value: DOMHighResTimeStamp): Self = StObject.set(x, "jitterBufferTarget", value.asInstanceOf[js.Any])
    
    inline def setJitterBufferTargetNull: Self = StObject.set(x, "jitterBufferTarget", null)
    
    inline def setTrack(value: org.scalajs.dom.MediaStreamTrack): Self = StObject.set(x, "track", value.asInstanceOf[js.Any])
    
    inline def setTransform(value: RTCRtpTransform): Self = StObject.set(x, "transform", value.asInstanceOf[js.Any])
