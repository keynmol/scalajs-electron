...
type Base64URLString = java.lang.String
...
type CSSStartingStyleRule = CSSGroupingRule
...
type EncodedAudioChunkOutputCallback = js.Function2[
/* output */ EncodedAudioChunk, 
/* metadata */ js.UndefOr[EncodedAudioChunkMetadata], 
Unit]
...
type ImageBufferSource = AllowSharedBufferSource | org.scalajs.dom.ReadableStream[Any]
...
/**
  ...
  */
type NoInfer[T] = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify intrinsic */ Any
...
type PublicKeyCredentialClientCapabilities = Record[java.lang.String, scala.Boolean]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.std.AudioData
  - typings.std.VideoFrame
  - org.scalajs.dom.RTCDataChannel
  - js.typedarray.ArrayBuffer
*/
type Transferable = _Transferable | org.scalajs.dom.ReadableStream[Any] | WritableStream[Any] | (TransformStream[Any, Any]) | org.scalajs.dom.MessagePort | org.scalajs.dom.RTCDataChannel | js.typedarray.ArrayBuffer
...
type ViewTransitionUpdateCallback = js.Function0[Any]
