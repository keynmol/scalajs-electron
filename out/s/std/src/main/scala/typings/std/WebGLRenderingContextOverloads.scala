...
trait WebGLRenderingContextOverloads extends StObject {
  ...
  /* standard dom */
  def bufferData(target: GLenum, data: AllowSharedBufferSource, usage: GLenum): Unit = js.native
  ...
  /* standard dom */
  def bufferSubData(target: GLenum, offset: GLintptr, data: AllowSharedBufferSource): Unit = js.native
