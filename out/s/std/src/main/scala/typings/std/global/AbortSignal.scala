...
object AbortSignal {
  ...
  /* standard dom */
  inline def any(signals: js.Array[org.scalajs.dom.AbortSignal]): org.scalajs.dom.AbortSignal = ^.asInstanceOf[js.Dynamic].applyDynamic("any")(signals.asInstanceOf[js.Any]).asInstanceOf[org.scalajs.dom.AbortSignal]
