...
Instantiable1[
  ...
  def from(elements: js.Iterable[Double]): js.typedarray.Int32Array = js.native
  /**
    * Creates an array from an array-like or iterable object.
    * @param arrayLike An array-like object to convert to an array.
  ...
  def from[T](elements: js.Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, Double]): js.typedarray.Int32Array = js.native
  def from[T](elements: js.Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ Double, Double], thisArg: Any): js.typedarray.Int32Array = js.native
  def from[T](elements: js.Iterable[T], mapfn: Unit, thisArg: Any): js.typedarray.Int32Array = js.native
  /**
    * Creates an array from an array-like or iterable object.
    * @param elements An iterable object to convert to an array.
    * @param mapfn A mapping function to call on every element of the array.
  ...
  /* standard es2015.iterable */
  @JSName("from")
  def from_T[T](elements: js.Iterable[T]): js.typedarray.Int32Array = js.native
