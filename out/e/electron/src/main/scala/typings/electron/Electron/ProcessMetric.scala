...
trait ProcessMetric extends StObject {
  ...
  /**
    ...
    */
  var `type`: Browser | Tab | typings.electron.electronStrings.Utility | Zygote | (`Sandbox helper`) | GPU | (`Pepper Plugin`) | (`Pepper Plugin Broker`) | Unknown
}
object ProcessMetric {
  ...
  inline def apply(
    ...
    memory: MemoryInfo,
    pid: Double,
    `type`: Browser | Tab | typings.electron.electronStrings.Utility | Zygote | (`Sandbox helper`) | GPU | (`Pepper Plugin`) | (`Pepper Plugin Broker`) | Unknown
  ): ProcessMetric = {
  ...
  implicit open class MutableBuilder[Self <: ProcessMetric] (val x: Self) extends AnyVal {
    ...
    inline def setType(
      value: Browser | Tab | typings.electron.electronStrings.Utility | Zygote | (`Sandbox helper`) | GPU | (`Pepper Plugin`) | (`Pepper Plugin Broker`) | Unknown
