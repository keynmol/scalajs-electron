...
trait DownloadItem extends StObject {
  ...
  def addListener(
    event: done,
    listener: js.Function2[/* event */ Event[js.Object], /* state */ completed | cancelled | interrupted, Unit]
  ): this.type = js.native
  def addListener(
    event: updated,
    listener: js.Function2[/* event */ Event[js.Object], /* state */ progressing | interrupted, Unit]
  ): this.type = js.native
  ...
  /**
    ...
    */
  def getCurrentBytesPerSecond(): Double = js.native
  ...
  /**
    ...
    */
  def getEndTime(): Double = js.native
  ...
  /**
    ...
    */
  def getPercentComplete(): Double = js.native
