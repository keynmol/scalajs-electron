...
trait WebContentsWillFrameNavigateEventParams extends StObject {
...
object WebContentsWillFrameNavigateEventParams {
  
  inline def apply(isMainFrame: Boolean, isSameDocument: Boolean, url: String): WebContentsWillFrameNavigateEventParams = {
    ...
    __obj.asInstanceOf[WebContentsWillFrameNavigateEventParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebContentsWillFrameNavigateEventParams] (val x: Self) extends AnyVal {
