...
trait ClearSharedDictionaryCacheForIsolationKeyOptions extends StObject {
...
object ClearSharedDictionaryCacheForIsolationKeyOptions {
  
  inline def apply(frameOrigin: String, topFrameSite: String): ClearSharedDictionaryCacheForIsolationKeyOptions = {
    val __obj = js.Dynamic.literal(frameOrigin = frameOrigin.asInstanceOf[js.Any], topFrameSite = topFrameSite.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClearSharedDictionaryCacheForIsolationKeyOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ClearSharedDictionaryCacheForIsolationKeyOptions] (val x: Self) extends AnyVal {
