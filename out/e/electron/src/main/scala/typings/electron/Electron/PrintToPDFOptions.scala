...
import typings.electron.electronStrings.A0
import typings.electron.electronStrings.A1
import typings.electron.electronStrings.A2
...
import typings.electron.electronStrings.A6
import typings.electron.electronStrings.Ledger
...
trait PrintToPDFOptions extends StObject {
  ...
  /**
    ...
    * @experimental
    */
  var generateDocumentOutline: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * @experimental
    */
  var generateTaggedPDF: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    */
  var pageSize: js.UndefOr[A0 | A1 | A2 | A3 | A4 | A5 | A6 | Legal | Letter | Tabloid | Ledger | Size] = js.undefined
...
object PrintToPDFOptions {
  ...
  implicit open class MutableBuilder[Self <: PrintToPDFOptions] (val x: Self) extends AnyVal {
    ...
    inline def setGenerateDocumentOutline(value: Boolean): Self = StObject.set(x, "generateDocumentOutline", value.asInstanceOf[js.Any])
    
    inline def setGenerateDocumentOutlineUndefined: Self = StObject.set(x, "generateDocumentOutline", js.undefined)
    
    inline def setGenerateTaggedPDF(value: Boolean): Self = StObject.set(x, "generateTaggedPDF", value.asInstanceOf[js.Any])
    
    inline def setGenerateTaggedPDFUndefined: Self = StObject.set(x, "generateTaggedPDF", js.undefined)
    ...
    inline def setPageSize(value: A0 | A1 | A2 | A3 | A4 | A5 | A6 | Legal | Letter | Tabloid | Ledger | Size): Self = StObject.set(x, "pageSize", value.asInstanceOf[js.Any])
