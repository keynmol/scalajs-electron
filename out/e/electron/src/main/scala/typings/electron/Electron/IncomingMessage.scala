...
trait IncomingMessage extends StObject {
  ...
  @JSName("addListener")
  def addListener_aborted(event: aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("off")
  def off_aborted(event: aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("off")
  def off_data(
    event: data,
    listener: js.Function1[
  ...
  /**
    ...
    */
  @JSName("on")
  def on_aborted(event: aborted, listener: js.Function0[Unit]): this.type = js.native
  /**
  ...
  @JSName("once")
  def once_aborted(event: aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("once")
  def once_data(
    event: data,
    listener: js.Function1[
  ...
  def removeListener_aborted(event: aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("removeListener")
