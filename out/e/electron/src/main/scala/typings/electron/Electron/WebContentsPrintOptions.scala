...
trait WebContentsPrintOptions extends StObject {
  ...
  /**
    ...
    * `width`.
    */
  var pageSize: js.UndefOr[A0 | A1 | A2 | A3 | A4 | A5 | A6 | Legal | Letter | Tabloid | Size] = js.undefined
...
object WebContentsPrintOptions {
  ...
  inline def apply(): WebContentsPrintOptions = {
  ...
  implicit open class MutableBuilder[Self <: WebContentsPrintOptions] (val x: Self) extends AnyVal {
    ...
    inline def setPageSize(value: A0 | A1 | A2 | A3 | A4 | A5 | A6 | Legal | Letter | Tabloid | Size): Self = StObject.set(x, "pageSize", value.asInstanceOf[js.Any])
