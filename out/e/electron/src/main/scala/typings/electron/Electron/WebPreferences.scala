...
trait WebPreferences extends StObject {
  ...
  /**
    ...
    * @experimental
    */
  var enableCornerSmoothingCSS: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var enableDeprecatedPaste: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    */
  var offscreen: js.UndefOr[Offscreen | Boolean] = js.undefined
...
object WebPreferences {
  ...
  implicit open class MutableBuilder[Self <: WebPreferences] (val x: Self) extends AnyVal {
    ...
    inline def setEnableCornerSmoothingCSS(value: Boolean): Self = StObject.set(x, "enableCornerSmoothingCSS", value.asInstanceOf[js.Any])
    
    inline def setEnableCornerSmoothingCSSUndefined: Self = StObject.set(x, "enableCornerSmoothingCSS", js.undefined)
    
    inline def setEnableDeprecatedPaste(value: Boolean): Self = StObject.set(x, "enableDeprecatedPaste", value.asInstanceOf[js.Any])
    
    inline def setEnableDeprecatedPasteUndefined: Self = StObject.set(x, "enableDeprecatedPaste", js.undefined)
    ...
    inline def setOffscreen(value: Offscreen | Boolean): Self = StObject.set(x, "offscreen", value.asInstanceOf[js.Any])
