...
trait WebContentsDidStartNavigationEventParams extends StObject {
...
object WebContentsDidStartNavigationEventParams {
  
  inline def apply(isMainFrame: Boolean, isSameDocument: Boolean, url: String): WebContentsDidStartNavigationEventParams = {
    ...
    __obj.asInstanceOf[WebContentsDidStartNavigationEventParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebContentsDidStartNavigationEventParams] (val x: Self) extends AnyVal {
