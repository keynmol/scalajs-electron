...
trait Details extends StObject {
  ...
  /**
    ...
    */
  var `type`: typings.electron.electronStrings.Utility | Zygote | (`Sandbox helper`) | GPU | (`Pepper Plugin`) | (`Pepper Plugin Broker`) | Unknown
}
object Details {
  ...
  inline def apply(
    ...
    `type`: typings.electron.electronStrings.Utility | Zygote | (`Sandbox helper`) | GPU | (`Pepper Plugin`) | (`Pepper Plugin Broker`) | Unknown
  ): Details = {
  ...
  implicit open class MutableBuilder[Self <: Details] (val x: Self) extends AnyVal {
    ...
    inline def setType(
      value: typings.electron.electronStrings.Utility | Zygote | (`Sandbox helper`) | GPU | (`Pepper Plugin`) | (`Pepper Plugin Broker`) | Unknown
