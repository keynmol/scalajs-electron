...
trait CrashReporter extends StObject {
  ...
  /**
    ...
    */
  def getLastCrashReport(): CrashReport | Null
...
object CrashReporter {
  ...
  implicit open class MutableBuilder[Self <: CrashReporter] (val x: Self) extends AnyVal {
    ...
    inline def setGetLastCrashReport(value: () => CrashReport | Null): Self = StObject.set(x, "getLastCrashReport", js.Any.fromFunction0(value))
