...
object Common {
  ...
  object Event {
    ...
    inline def apply[Params /* <: js.Object */](
      ...
      x: Double,
      y: Double
    ): typings.electron.Electron.Common.Event[Params] = {
      ...
      __obj.asInstanceOf[typings.electron.Electron.Common.Event[Params]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.electron.Electron.Common.Event[?], Params /* <: js.Object */] (val x: Self & typings.electron.Electron.Common.Event[Params]) extends AnyVal {
