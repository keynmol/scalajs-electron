...
object Display {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(accelerometerSupport = accelerometerSupport.asInstanceOf[js.Any], bounds = bounds.asInstanceOf[js.Any], colorDepth = colorDepth.asInstanceOf[js.Any], colorSpace = colorSpace.asInstanceOf[js.Any], depthPerComponent = depthPerComponent.asInstanceOf[js.Any], detected = detected.asInstanceOf[js.Any], displayFrequency = displayFrequency.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], internal = internal.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], maximumCursorSize = maximumCursorSize.asInstanceOf[js.Any], monochrome = monochrome.asInstanceOf[js.Any], nativeOrigin = nativeOrigin.asInstanceOf[js.Any], rotation = rotation.asInstanceOf[js.Any], scaleFactor = scaleFactor.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], touchSupport = touchSupport.asInstanceOf[js.Any], workArea = workArea.asInstanceOf[js.Any], workAreaSize = workAreaSize.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: Display] (val x: Self) extends AnyVal {
    ...
    inline def setDetected(value: Boolean): Self = StObject.set(x, "detected", value.asInstanceOf[js.Any])
    ...
    inline def setMaximumCursorSize(value: Size): Self = StObject.set(x, "maximumCursorSize", value.asInstanceOf[js.Any])
    
    inline def setMonochrome(value: Boolean): Self = StObject.set(x, "monochrome", value.asInstanceOf[js.Any])
    
    inline def setNativeOrigin(value: Point): Self = StObject.set(x, "nativeOrigin", value.asInstanceOf[js.Any])
