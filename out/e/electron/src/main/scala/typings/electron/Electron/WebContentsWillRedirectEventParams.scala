...
trait WebContentsWillRedirectEventParams extends StObject {
...
object WebContentsWillRedirectEventParams {
  
  inline def apply(isMainFrame: Boolean, isSameDocument: Boolean, url: String): WebContentsWillRedirectEventParams = {
    ...
    __obj.asInstanceOf[WebContentsWillRedirectEventParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebContentsWillRedirectEventParams] (val x: Self) extends AnyVal {
