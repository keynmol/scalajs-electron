...
object Main {
  ...
  object Event {
    ...
    inline def apply[Params /* <: js.Object */](
      ...
      x: Double,
      y: Double
    ): typings.electron.Electron.Main.Event[Params] = {
      ...
      __obj.asInstanceOf[typings.electron.Electron.Main.Event[Params]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.electron.Electron.Main.Event[?], Params /* <: js.Object */] (val x: Self & typings.electron.Electron.Main.Event[Params]) extends AnyVal {
