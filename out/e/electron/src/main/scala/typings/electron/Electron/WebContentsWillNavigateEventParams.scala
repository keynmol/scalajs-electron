...
trait WebContentsWillNavigateEventParams extends StObject {
...
object WebContentsWillNavigateEventParams {
  
  inline def apply(isMainFrame: Boolean, isSameDocument: Boolean, url: String): WebContentsWillNavigateEventParams = {
    ...
    __obj.asInstanceOf[WebContentsWillNavigateEventParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebContentsWillNavigateEventParams] (val x: Self) extends AnyVal {
