...
/* Inlined {preventDefault (): void,  readonly defaultPrevented :boolean} & Params */
...
object Event {
  ...
  inline def apply[Params /* <: js.Object */](
    ...
    __obj.asInstanceOf[Event[Params]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Event[?], Params /* <: js.Object */] (val x: Self & Event[Params]) extends AnyVal {
