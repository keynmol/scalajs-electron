...
trait ProtocolResponse extends StObject {
  ...
  /**
    ...
    */
  var data: js.UndefOr[
    (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Buffer */ Any) | String | ReadableStream[Any]
  ] = js.undefined
...
object ProtocolResponse {
  ...
  implicit open class MutableBuilder[Self <: ProtocolResponse] (val x: Self) extends AnyVal {
    ...
    inline def setData(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Buffer */ Any) | String | ReadableStream[Any]
