...
import typings.electron.electronStrings.showAllTabs
...
object MenuItemConstructorOptions {
  ...
  implicit open class MutableBuilder[Self <: MenuItemConstructorOptions] (val x: Self) extends AnyVal {
    ...
    inline def setClick(
      value: (/* menuItem */ MenuItem, /* window */ js.UndefOr[BaseWindow], /* event */ KeyboardEvent) => Unit
