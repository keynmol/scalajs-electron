...
import typings.electron.anon.TypeofUtility
...
import typings.electron.electronStrings.electronSlashutility
...
trait NodeRequire extends StObject {
  ...
  def apply(moduleName: electronSlashutility): TypeofUtility = js.native
}
