...
object mod {
  ...
  @JSImport("electron", "IpcMainServiceWorker")
  @js.native
  ...
  @JSImport("electron", "View")
  @js.native
  open class View ()
    extends StObject
       with typings.electron.Electron.View
  
  @JSImport("electron", "WebContentsView")
  @js.native
  ...
  object nativeImage {
    ...
    ): NativeImage_ = (^.asInstanceOf[js.Dynamic].applyDynamic("createFromBitmap")(buffer.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[NativeImage_]
    ...
    inline def createFromBuffer(
      buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Buffer */ Any
    ): NativeImage_ = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromBuffer")(buffer.asInstanceOf[js.Any]).asInstanceOf[NativeImage_]
    inline def createFromBuffer(
      buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Buffer */ Any,
      options: CreateFromBufferOptions
    ): NativeImage_ = (^.asInstanceOf[js.Dynamic].applyDynamic("createFromBuffer")(buffer.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[NativeImage_]
  ...
  object session {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromPath(path: String): Session_ = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPath")(path.asInstanceOf[js.Any]).asInstanceOf[Session_]
    inline def fromPath(path: String, options: FromPathOptions): Session_ = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPath")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Session_]
  }
