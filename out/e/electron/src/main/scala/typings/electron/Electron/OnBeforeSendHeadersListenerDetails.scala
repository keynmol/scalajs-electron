...
trait OnBeforeSendHeadersListenerDetails extends StObject {
  ...
  /**
    ...
    * or been destroyed.
    */
  var frame: js.UndefOr[WebFrameMain_ | Null] = js.undefined
...
object OnBeforeSendHeadersListenerDetails {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OnBeforeSendHeadersListenerDetails] (val x: Self) extends AnyVal {
