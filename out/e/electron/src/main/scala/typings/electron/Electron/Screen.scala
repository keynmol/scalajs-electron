...
trait Screen extends StObject {
  ...
  def addListener_displayadded(
    event: `display-added`,
    listener: js.Function2[/* event */ Event[js.Object], /* newDisplay */ Display, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  def addListener_displayremoved(
    ...
    listener: js.Function2[/* event */ Event[js.Object], /* oldDisplay */ Display, Unit]
  ): this.type = js.native
  ...
  @JSName("off")
  def off_displayadded(
    event: `display-added`,
    listener: js.Function2[/* event */ Event[js.Object], /* newDisplay */ Display, Unit]
  ): this.type = js.native
  @JSName("off")
  def off_displaymetricschanged(
    event: `display-metrics-changed`,
    listener: js.Function3[
      /* event */ Event[js.Object], 
      /* display */ Display, 
