...
import typings.electron.Electron.WebUtils
...
inline def NodeEventEmitter: /* import warning: ResolveTypeQueries.newMembers rewritten Couldn't resolve typeof imported_events.EventEmitter */ Any = ^.asInstanceOf[js.Dynamic].selectDynamic("NodeEventEmitter").asInstanceOf[/* import warning: ResolveTypeQueries.newMembers rewritten Couldn't resolve typeof imported_events.EventEmitter */ Any]
...
inline def webUtils: WebUtils = ^.asInstanceOf[js.Dynamic].selectDynamic("webUtils").asInstanceOf[WebUtils]
