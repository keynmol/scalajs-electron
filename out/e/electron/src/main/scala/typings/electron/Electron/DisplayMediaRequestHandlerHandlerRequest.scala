...
object DisplayMediaRequestHandlerHandlerRequest {
  ...
  inline def apply(audioRequested: Boolean, securityOrigin: String, userGesture: Boolean, videoRequested: Boolean): DisplayMediaRequestHandlerHandlerRequest = {
    val __obj = js.Dynamic.literal(audioRequested = audioRequested.asInstanceOf[js.Any], securityOrigin = securityOrigin.asInstanceOf[js.Any], userGesture = userGesture.asInstanceOf[js.Any], videoRequested = videoRequested.asInstanceOf[js.Any], frame = null)
