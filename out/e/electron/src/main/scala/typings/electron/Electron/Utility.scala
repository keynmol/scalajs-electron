...
object Utility {
  ...
  object Event {
    ...
    inline def apply[Params /* <: js.Object */](
      ...
      x: Double,
      y: Double
    ): typings.electron.Electron.Utility.Event[Params] = {
      ...
      __obj.asInstanceOf[typings.electron.Electron.Utility.Event[Params]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.electron.Electron.Utility.Event[?], Params /* <: js.Object */] (val x: Self & typings.electron.Electron.Utility.Event[Params]) extends AnyVal {
