...
trait ClientRequest extends StObject {
  ...
  def end(chunk: String, encoding: String, callback: js.Function0[Unit]): this.type = js.native
  def end(chunk: String, encoding: Unit, callback: js.Function0[Unit]): this.type = js.native
  def end(
    chunk: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Buffer */ Any
  ): this.type = js.native
  def end(
    chunk: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Buffer */ Any,
    encoding: String
  ...
  def end(chunk: Unit, encoding: String, callback: js.Function0[Unit]): this.type = js.native
  def end(chunk: Unit, encoding: Unit, callback: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("off")
  def off_abort(event: abort, listener: js.Function0[Unit]): this.type = js.native
  @JSName("off")
  ...
  @JSName("off")
  def off_finish(event: finish, listener: js.Function0[Unit]): this.type = js.native
  @JSName("off")
  def off_login(
    event: login,
    listener: js.Function2[
  ...
  @JSName("off")
  def off_response(event: response, listener: js.Function1[/* response */ IncomingMessage, Unit]): this.type = js.native
